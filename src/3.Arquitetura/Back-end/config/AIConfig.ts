...
Chaves obrigatórias (JSON, camelCase, sem aninhar outro objeto): especie, nomeComum, diagnosticoBack, nivelConfianca, descricao, caracteristicas, habitat, cicloDeVida, proximoEstagio.

diagnosticoBack ∈ {ovo,larva,ninfa,pupa,juvenil,subadulto,adulto,desconhecido} em minúsculas. nivelConfianca entre 0 e 1.
...
{"especie":"…","nomeComum":"…","diagnosticoBack":"larva","nivelConfianca":0.5,"descricao":"…","caracteristicas":["…"],"habitat":"…","cicloDeVida":"…","proximoEstagio":"…"}`;
